...
@Component
public class DeGamesplanetCom implements HtmlCrawler, Runnable {
  ...
  public void run() {
    ...
    for (String url : deGamesplanetCom.startUrls()) {
      baseCrawler.crawlHtml(deGamesplanetCom, url, new HashSet<>());
    }
  }
}
